...
class DecreasingPLNPage3 extends StatelessWidget {
  const DecreasingPLNPage3({super.key});
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.only(left: 10.0, right: 10.0),
            child: Text(
              "Aby obliczyć część kapitałową musimy podzielić Początkową kwotę kredytu przez Okres kredytowania.\n\n"
