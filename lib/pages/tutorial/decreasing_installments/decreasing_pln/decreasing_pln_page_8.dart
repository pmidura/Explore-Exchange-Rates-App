...
class DecreasingPLNPage8 extends StatelessWidget {
  const DecreasingPLNPage8({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Text(
            "Kredyt w PLN - Raty malejące - Excel cd.",
          ...
          Container(
            ...
            decoration: const BoxDecoration(
              image: DecorationImage(
                fit: BoxFit.fitWidth,
                image: AssetImage("assets/decreasing_pln_images/step_4.PNG"),
              ),
            ),
          ),
          Padding(
